            ...
            <div class='max-vh-100'>
                <div class='mx-lg-n4 mt-1'>
                    ...
                    <div class='row g-3 ms-3 mx-3'>
                        {/* 왼쪽카드 */}
                        <div class='min-vh-70 border-end' style={{ width: "21%" }}>
                            <div class='col-auto mb-5'>
                                <h2 class='mb-2'>공급사 상세 조회</h2>
                                <h5 class='text-700 fw-semi-bold'>Search Supplier Detail</h5>
                            </div>
                            <div class='form-icon-container mb-5 mt-1 d-flex'>
                                <div className='flex-grow-1 me-1'>
                                    <input class='form-control form-icon-input' type='text' placeholder='공급사명' />
                                    <span class='fa-regular fa-building text-700 fs--1 form-icon'></span>
                                </div>
                                <button className='btn btn-primary btn-sm'>검색</button>
                            </div>
                            <ul class='nav nav-phoenix-pills mb-3 d-sm-none d-xl-flex' id='contactListTab' data-chat-thread-tab='data-chat-thread-tab' role='tablist'>
                                        ...
                                        <button class='btn btn-phoenix-info p-2 w-100 border-100'>
                                            <div className='d-flex justify-content-between ms-3'>
                                                ...
                                                <div className='flex-grow-1 align-self-center'>
                                                    ...
                                                    <h5 class='mb-1 mt-2 text-primary'>공급사명</h5>
                            ...
                            <div class='card mb-3'>
                                <div class='card-body'>
                                    <div className='border-bottom d-flex justify-content-between align-items-center '>
                                        <div>
                                            <h4 class='card-title mb-1 mt-2 mb-3'>공급사 상세정보</h4>
                                        </div>
                        ...
                        <div class='col-6 min-vh-75'>
                            <div className='card me-2 h-100'>
                                <div className='ms-3 mx-3 mt-3 border-bottom d-flex justify-content-between align-items-center '>
                                    <div>
                                        <h3 class='card-title mb-1 mt-2'>부품 제안 리스트</h3>
